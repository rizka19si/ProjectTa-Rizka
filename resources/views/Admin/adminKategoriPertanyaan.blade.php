            ...
            <div class="main-wrapper">
                ...
                <main class="main users chart-page" id="skip-target">
                    <div class="container">
                        ...
                        @endforeach
                        @foreach ($tkt as $tlink)
                        @endforeach
                        
                        <h2 class="main-title" style="color: cornflowerblue"><a href="http://127.0.0.1:8000/kategori">DAFTAR KATEGORI</a> / <a href="http://127.0.0.1:8000/kategori/detail/{{$klink->idKategoriProduk}}">{{$klink->nama_kategori}}</a> / TKT {{$tlink->tkt}}</h2>
                    
                        <h3 style="color: cornflowerblue; font-weight:400">Tambah Indikator</h3>
                        <form action="/kategori/pertanyaanstore" method="POST">
                            <div class="row" style="margin: 20px; width:100%">
                                @csrf
                                <input type="text" name="pertanyaan" placeholder="Masukan Indikator Pertanyaan"
                                    style="background-color:white; padding:10px; margin-right:10px; width:95%"
                                    required>
                                @foreach ($tkt as $t)
                                    <input type="hidden" name="idTkt" value="{{ $t->idTkt }}">
                                    <input type="hidden" name="idKategoriProduk" value="{{ $t->idKategoriProduk }}">
                                @endforeach
                                <button type="submit"
                                        ...
                                        <tbody>
                                            @foreach ($indikator as $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/kategori/pertanyaanhapus/{{ $item->idIndikator }}"
                                                            style="color:red">
                                                            < Hapus>
                                                        </a>
                                                    </td>
